...
<body>
    ...
    <main id="main">
        ...
        <article class="box">  
            ...
            <p> Nell'area più frequentata delle nostre piste, si trova il rifugio Camposcuola che offre un buon menù adatto a tutti.</p> 
            <p>Durante la settimana è disponibile un menù fisso a 15€ (primo + secondo) e uno a 10€ (solo primo o solo secondo); ricordiamo che in entrambi sono incluse le bevande.</p><p>Da quest'anno, ci sarà qualcosa di nuovo: una piccola parte sarà dedicata alla pizzeria, la quale prevede anche un menù fisso a 12€ per pizza farcita e bibita.</p>
            <p>Numero di telefono: 3330000002</p>
        </article>
        <article class="box">  
            <h3> Bar <span lang="en">"Fast & go"</span> </h3>
            <p> Per gli amanti di panini e birra, ai piedi delle piste 1 e 5, si trova questo bar che sicuramente soddisferà le vostre richieste: velocità nel servizio, ottima qualità e prezzo economico: calza a pennello per chi ha voglia di mangiare qualcosa al volo senza perdere troppo tempo.</p>
            <p>Il menù varia dai panini classici con l’affettato (soppressa veneta, speck, prosciutto crudo e cotto e salame) ai più particolare e sfiziosi con cotoletta, <span lang="en"> wurstel, hamburger </span> e doppio strato <span lang="en"> hamburger </span> con formaggio caldo e filante. Ovviamente non possono mancare <span lang="en"> ketchup </span>, maionese e salsa <span lang="en"> barbecue</span>.</p> 
        ...
        <div class="content" id="scuola">
            ...
            <p>Offriamo corsi di sci e <span lang="en">snowboard</span> per qualsiasi età. Affrettati a prenotare la tua lezione di prova!</p><p>Numero di telefono: 3330000005</p>
        </div>
    </main>
